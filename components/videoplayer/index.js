/**
 * GITHUB: https://github.com/expo/videoplayer
 * Modifications made to enable the full-screen feature correctly.
 */
...
export default class VideoPlayer extends React.Component {
  ...
  orientationChangeHandler() {
    ...
    const portriateHeight = newWidth * (9 / 16);
    const videoHeight = 
      isLandscape ? newHeight : portriateHeight;
